# Evaluation guide
This documents provides the instructions that will be followed by the evaluator when the project is finished
...
If you didn't score all the points on the mandatory part during this defense bonuses will be totally ignored.
